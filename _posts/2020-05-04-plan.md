...
|-------------------------|---------|------------------|--------|
| Work package number     | 2       | Lead institution |  MetNorway |
|-------------------------|-------------------------------------|
|Work package short title |	Model analysis and diagnostics  |
|-------------------------|-------------------------------------|
| Participants		  | MetNorway, FMI, DMI, NERSC, Sigma2/UiO, |
|                         | SMHI, INAR            	        |
|-------------------------|-------------------------------------|
| PMs per participant	  |                                     |		
|-------------------------|-------------------------------------|
...
- Task 2.1 (MetNorway, NERSC): Organization of workshop/hackathon at the beginning of
the project on ESMValTool to collect user requirements (M1-M6)
- Task 2.2 (FMI, MetNorway, NERSC): Development of new ESMValTool diagnostic
modules for the Nordic regions (M7-M24)
- Task 2.3 (NERSC, MetNorway, FMI, Sigma2/UiO): Development of teaching material for learning
...
|-------------------------|-------------------------------------|
| Participants		  |  NSC, DMI, CSC, NORCE, MetNorway        |
|-------------------------|-------------------------------------|
| PMs per participant	  |                                     |		
|-------------------------|-------------------------------------|
| Start month	          | 2020-06 | End month	       |2023-05 |
...
- Task 3.2 (NSC, NORCE, MetNorway) : Towards FAIR Nordic climate modeling data
