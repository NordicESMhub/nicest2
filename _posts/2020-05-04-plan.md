...
- **Task 3.2 (NSC, NORCE, MET Norway): Towards FAIR Nordic climate modeling data (M4 -- M36)** <br>
...
needs to be done to make climate data FAIR (for NorESM and EC-Earth). (M9)
...
- **Task 4.1 (Sigma2/UiO, NORCE, NERSC, FMI): Reproducible workflows for deploying and running ESM on future HPCs (M4 -- M30)** <br>
...
- **Task 4.2  (NORCE, Sigma2/UiO, FMI): Efficiency of Nordic ESMs on future euroHPC (M4 -- M36)** <br>
...
characterize the Nordic ESM involvement in EuroHPC (M18)
...
|-------|---------------------------------------------------------------------|------------|-------------|-------------|
| *D4.4*| Workshop (face to face meeting) with national HPC providers for EuroHPC | Steering Group |  M18 |  November 2021 |
|-----------------------------------------------------------------------------|------------|-------------|-------------|
